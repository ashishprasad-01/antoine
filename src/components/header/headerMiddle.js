...
export default function HeaderMiddle() {
  ...
  let [minicart, setMinicart] = useState(true);
  ...
  return (
    <>
      <div className={header.container}>
        <div className={header.middleContainer}>
          <div id={header.menu} onClick={toggle}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960">
              <path d="M120 816v-60h720v60H120Zm0-210v-60h720v60H120Zm0-210v-60h720v60H120Z" />
            </svg>
          </div>

          {state ? <HamburgerMenu toggle={toggle} /> : <></>}
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
                <g id="search" transform="translate(-2 -2)">
                  <path
                    ...
                    d="M8.9-1A9.9,9.9,0,1,1-1,8.9,9.911,9.911,0,0,1,8.9-1Zm0,17.6A7.7,7.7,0,1,0,1.2,8.9,7.709,7.709,0,0,0,8.9,16.6Z"
                    transform="translate(3 3)"
                  />
                  <path
                    id="Line_1"
                    data-name="Line 1"
                    d="M4.885,5.985a1.1,1.1,0,0,1-.778-.322L-.678.878A1.1,1.1,0,0,1,.878-.678L5.663,4.107a1.1,1.1,0,0,1-.778,1.878Z"
                    transform="translate(18.015 18.015)"
                  />
                </g>
              </svg>
            </button>
          ...
          <div className={header.cart} onClick={() => setMinicart(!minicart)}>
