...
import { deleteCartItem, incDecQuantity } from '../../store/actions/cartActions';
                                ...
                                return (
                                    <>
                                        ...
                                        <tr id={cart.cartActionBtn}>
                                            <td>
                                                <span id={cart.wishlist}>Add to Wishlist</span>
                                            </td>
                                            <td>
                                                <svg id={cart.pencil} xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
                                            ...
                                            <td onClick={() => dispatch(deleteCartItem(item.id))}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 14 15">
