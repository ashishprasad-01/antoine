      ...
      <div className={style.Container} id={style.productDetailContainer}>
        ...
        <div className={style.productDetailRight}>
          <div className={style.description}>
            ...
            <p><span>{productDetail.author}</span> (Author),&nbsp; <span>{productDetail.narrator}</span> (Narrator), &nbsp;<span>{productDetail.publisher}</span> (publisher)</p>
          ...
          <div className={style.loginButton}>
            ...
            <button>
              ...
              </svg>Sign-In To Purchase Instantly
            </button>
          </div>
            ...
            <ul className={style.item}>
              <Link>
                <li className={style.items}>
                  ...
                  </svg> Check In Store Availability
                </li>
              </Link>
          ...
          <div className={style.delivery}>
            <p>For International: 1-2 days</p>
            <p>For Lebanon: 6-8 days</p>
          </div>
        </div>
      </div>
        <DesktopProductDesc/>
