  ...
  return (
    <>
      <div className={checkout.leftContainer}>
        <div
          className={checkout.leftSideHeader}
          id={checkout.leftSideMobileHeader}
        >
        ...
        <div className={checkout.leftSideBody}>
          <div className={checkout.addresWrapper}>
            <div className={checkout.addressContainer}>
              <div
                className={`${checkedAddress ? checkout.addressIsActive : ""} ${
                  checkout.address
                }`}
                onClick={() => setCheckAddress(true)}
              >
                <div className={checkout.addressContent}>
                  <span className={checkout.addressTitle}>
                    {t("Veronica Costello")}
                  </span>
                  <span className={checkout.addressBody}>
                    6146 {t("Honey Bluff Parkway Calder")}, Michigan 49628-7978
                  </span>
                  <span className={checkout.addressMno}>(555) 229-3326</span>
                  <strong>{t("Ship Here")}</strong>
                  {checkedAddress ? (
              ...
              <div
                className={`${
                  !checkedAddress ? checkout.addressIsActive : ""
                } ${checkout.address}`}
            ...
            {modalIsOpen ? (
              <AddressForm modalIsOpen={modalIsOpen} setIsOpen={setIsOpen} />
            ) : (
              ""
            )}
          </div>
          ...
          <div className={checkout.shippingMethodContainer}>
            ...
            <div className={checkout.paymentMethodContainer}>
              <div className={checkout.paymentMethod}>
                ...
                />{" "}
                <label htmlFor="20000">LBP 20,000</label>{" "}
                <span>
                  {t("Click")} & {t("Collect")}
                </span>
              </div>
                    ...
                    <div className={checkout.pickupAddressDetails}>
                      ...
                      <div className={checkout.pickupAddressTitle}>
                        ...
                        <div className={checkout.pickupAddress}>
                          ...
                          <span className={checkout.pickupAddressMno}>
                            +961 1 331 811
                          </span>
                          <div className={checkout.moreAboutStore}>
                            <span>
                              ...
                              >
                                ...
                                <path
                                  d="M25.007 14.856l-14.342-14.34c-0.32-0.318-0.76-0.515-1.247-0.515s-0.927 0.197-1.247 0.515l-1.054 1.054c-0.319 0.319-0.516 0.76-0.516 1.247s0.197 0.928 0.516 1.247l12.047 12.047-12.060 12.053c-0.318 0.32-0.515 0.76-0.515 1.247s0.197 0.927 0.515 1.247l1.056 1.056c0.32 0.318 0.76 0.515 1.247 0.515s0.927-0.197 1.247-0.515l14.353-14.355c0.318-0.321 0.514-0.763 0.514-1.251s-0.196-0.93-0.514-1.251l0 0z"
                                  fill="#00838C"
                                ></path>
                              </svg>
                            </span>
